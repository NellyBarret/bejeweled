...
class Grid
{
    ...
    public:
        ...
        /*!
         * \fn          Jewel get_jewel()
         * \brief       This function converts char to a real image of a jewel, and returns it.
         * \param[in]   x : the x coordinates of the jewel
         * \param[in]   y : the y coordinates of the jewel
         * \return      The jewel.
         */
        Jewel get_jewel(int x, int y);
        ...
        /*!
         * \brief       Procedure.
         *              Make a regression test to verify that all is OK.
         */
        void grid_regression();   
};
